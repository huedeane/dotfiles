...
globalkeys = gears.table.join(
    ...
    awful.key(
        ...
        {description = "rofi menu run", group = "launcher"}
    ),
    ...
    awful.key(
        ...
        {description = "rofi deep run", group = "launcher"}
    ),
    ...
    awful.key(
        { modkey,           }, "c",     
        function () 
            awful.util.spawn("code /home/valteria/.config/awesome/rc.lua")
        end,
